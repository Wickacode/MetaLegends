  ...
  return (
    <nav id="navbar">
      <div className="linkList">
        <a href=""><img src={LogoMetaLegends} alt="logo meta legends" /></a>
        
        <ul>
          <li><a href="">meta legends</a></li>
          <li><a href="#sectionMetaLife">meta life</a></li>
          <li><a href="#sectionMetaConnect">meta connect</a></li>
          <li><a href="#sectionLegendsZone">legends zone</a></li>
          <li><a href="">Team</a></li>
        </ul>

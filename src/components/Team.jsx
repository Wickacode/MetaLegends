  ...
  return (
    <div className="team">
      <div className="teamDescription">
        <h2 className="title-with-gradient titleTeam">
          Our
          <br /> <span>team</span>
        </h2>
        <p>
          An experienced team of passionate entrepreneurs,art directors,
          developers and game makers dedicated to creating the future.{" "}
        </p>
      </div>

      <div
        className="teamContainer fade-in-scroll"

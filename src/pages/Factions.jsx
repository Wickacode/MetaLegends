    ...
    <div className="factionsContainer">
     ...
     <div className="factionsRightBloc">
        ...
        <div className="textSection">
          <h2>Celestials</h2>
          <p>Great guardians of the Metaverse, the Celestials are the most powerful of all classes with an influence and a power that is close to the Gods.<br /><br />As they are greatly evolved, they have developed a deep sense of ethics and morals that exist in symbiosis with their vision. They managed to coexist with Burners, despite their superiority.<br /><br />Their mission is to govern the Metaverse.</p>
        </div>
     </div>
    </div>
  );
